...
with col1:
    ...
    fig_ep.add_trace(go.Scatter(x=sub820ep['Date'], y=sub820ep['Free_Bins'], name="820 EP2", line=dict(dash='dash', color='black')))
    
    fig_ep.update_layout(title="Historical Development: Pallet Positions", height=400, margin=dict(l=0,r=0,t=40,b=0))
...
with col2:
    ...
    fig_k1.update_layout(title="Historical Development: Shelf Positions (K1)", height=400, margin=dict(l=0,r=0,t=40,b=0))
